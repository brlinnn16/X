...
async def _(event):
    ...
    await fifthon.send_file(
        "me", pic, caption=f"by :[برلين  <\>](https://t.me/o_3_s)"
    )
...
ᤑ المطور: [برلين<\>](https://t.me/o_3_s)
''')
...
ownerhson_id = 1374041647
@fifthon.on(events.NewMessage(outgoing=False, pattern='/br'))
